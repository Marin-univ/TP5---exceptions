...
class Executable {
    ...
    WeekEnd lewWeekEnd = new WeekEnd();
    lewWeekEnd.ajouterPersonne(pierre); 
	lewWeekEnd.ajouterPersonne(paul);
	lewWeekEnd.ajouterPersonne(marie);
	lewWeekEnd.ajouterPersonne(anne); 
	lewWeekEnd.ajouterDepense(d1);   
	lewWeekEnd.ajouterDepense(d2); 
	lewWeekEnd.ajouterDepense(d4);   
	lewWeekEnd.ajouterDepense(d3);
	lewWeekEnd.ajouterDepense(d5);
    }
}
